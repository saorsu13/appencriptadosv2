...
const NewSimEncrypted = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      simNumber: Yup.string()
        ...
        .test('valid-iccid', t('pages.newSim.fields.sim.invalidSim'), isValidIccid),
    }),
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      >
        <HeaderEncrypted owner="encriptados" iconBack="BalanceMain" />
...
export default NewSimEncrypted;