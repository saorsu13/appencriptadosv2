// src/screens/Balance/BalanceSettings/LaguageConf.tsx
...
export default function LaguageConf() {
          ...
          {mockData.map((item) => (
            ...
            >
              <Text
                ...
                style={[
                  styles.radioLabel,
                  { color: isDark ? theme.colors.contrast : theme.lightMode.colors.blueDark },
                ]}
              >
